 ...
 * @author csc190
 */
public class TestC3GameEngine extends GameEngine{
    
    public TestC3GameEngine(String mapPath, ICanvasDevice mainview, ICanvasDevice minimap, ICanvasDevice factoryPanel, ISoundDevice sound) {
