 ...
 * @author csc190
 */
public class TestD1GameEngine extends GameEngine {

    public TestD1GameEngine(String mapPath, ICanvasDevice mainview, ICanvasDevice minimap, ICanvasDevice factoryPanel, ISoundDevice sound) {
